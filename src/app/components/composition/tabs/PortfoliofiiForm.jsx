...
import SelectFii from '../../../../config/selects/SelectFii'
...
class PortfoliofiiForm extends Component {
  ...
  render() {
    const { redirect, portfoliofii, errors, fii_options, category_options, portfolio_options } = this.state
    ...
    if (redirect) {
      ...
      return (
        <>
              <h3 className="mt-4 mb-4">Editar / Adicionar Fiimoeda a uma Carteira</h3>
              {errors.length > 0 &&
                <div>
